...
of roughly 6.4. This document does not soften that. The point of a postmortem is
to find out why.
...
them to Opus while One Hot Key routed them to small local models. A frontier
model is simply better at the parts of this task that are interpretation rather
